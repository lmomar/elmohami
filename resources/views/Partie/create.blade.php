<!-- Modal -->
<div class="modal fade" id="modalAddPartie" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content panel panel-primary">
            ...
            <div class="modal-body panel-body">
                {!! Form::open(['route' => 'partie.store','method' => 'post','class' => 'form-horizontal','id' => 'FormAddPartie','role' => 'form']) !!}
                {{ csrf_field() }}
                <input type="hidden" name="partie_file_id" value="" id="partie_file_id">
