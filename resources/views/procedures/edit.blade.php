<!-- Modal -->
<div class="modal fade" id="modalEditProc" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content panel panel-primary">
            <div class="modal-header panel-heading">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title panel-title" id="myModalLabel">تعديل إجراء</h4>
            </div>
            <div class="modal-body panel-body">
                {!! Form::open(['route' => 'procedure.update','method' => 'put','class' => 'form-horizontal','id' => 'FormEditProc','role' => 'form']) !!}
                {{ csrf_field() }}
                <input type="hidden" name="proc_id" value="" id="proc_id">
